            ...
            child: SafeArea(
              child: Column(
                ...
                children: [
                  ...
                  Consumer<NavigateToPage>(
                    builder: (context, value, child) {
                      return CustomMenuItem().customMenuItem(icon: Icons.mark_email_unread_outlined,text: "Post grievance type",color:postGrievanceType.isSelected?const Color(0xFF000044):const Color(0xFFEBF2F9),onclick: (){
                        falseAllActiveMenuItem();
